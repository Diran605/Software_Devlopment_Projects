...
class GoodsReceivedNotePolicy
{
     ...
     */
    public function restore(User $user, GoodsReceivedNote $goodsReceivedNote): bool
    {
        return $user->hasAnyRole(['super-admin', 'branch-manager']);
    }
     ...
     */
    public function forceDelete(User $user, GoodsReceivedNote $goodsReceivedNote): bool
    {
